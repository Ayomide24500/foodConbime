  ...
  return (
    <div className="w-[320px] h-[100vh] fixed">
      <div className="border shadow-md w-[320px] h-[100%] bg-[white] flex items-center flex-col">
        ...
        <div className="border w-[250px] h-[120px] mt-[10px] rounded-[10px] flex justify-center items-center bg-[#6fae9c]">
          <div className=" w-[80%] h-[70%] flex justify-between items-center ">
            <div className="border w-[48%] h-[100%] rounded-[10px] shadow-md bg-[white]">
              <div className="text-[11px] font-[700] mr-[180px] mt-[10px] ml-[3px]">
                Balance
              </div>
              <div className="text-[13px] font-[700] mr-[180px] mt-[10px] ml-[3px] ">
                $12,234.50
              </div>
            </div>
        ...
        <div className="text-[10px] font-[700] mr-[180px] text-[grey]">
          Your Address
        </div>
        ...
        <div className="text-[10px] font-[700] mr-[185px] flex justify-center items-center w-[78%] ml-[185px] mt-[5px]">
          ...
          illo totam modi est sit.
        </div>
        <div className="flex mt-[8px] mb-[10px]">
          <div className="text-[8px] font-[700] border px-1 py-1 text-[black] mr-[5px] cursor-pointer">
            Add Details
          </div>
          <div className="text-[8px] font-[700] border px-1 py-1 text-[black] mr-[5px] cursor-pointer ml-[40px]">
            Add Note
          </div>
        </div>
        ...
        <div className="text-[10px] font-semibold mt-[20px]">
          Spend $1,080.00 more to reach FREE SHIPPING!
        </div>
        <div className="flex text-[11px] mt-[30px]">
          <button className="py-2 px-2 bg-black text-[white] font-[600] rounded-md">
            View Cart
          </button>
          <button className="py-2 px-2 bg-[#FF6A25] text-[white] font-[600] rounded-md ml-[10px]">
            CheckOut
          </button>
        </div>
      </div>
