...
const Sider = () => {
  ...
  return (
    <div
      ...
      style={{
        width: `${readToggle ? "210px" : "70px"}`,
      }}
    >
      <div className="m-3">
        {readToggle ? (
          <div
            className="cursor-pointer w-[50px] h-[50px] rounded-[50%] bg-[#39A88E] flex items-center justify-center  left-[10px]"
            onClick={() => {
          ...
          <div
            className="cursor-pointer w-[50px] h-[50px] rounded-[50%] bg-[#39A88E] flex items-center justify-center"
            onClick={() => {
