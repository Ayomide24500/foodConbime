          ...
          <div className="flex justify-between flex-wrap">
            <div className="border h-[250px] w-[250px] rounded-md">
              <div className="flex justify-between items-center w-[100%] p-2 h-[10%] mt-[3px] ">
                <span className="rounded border bg-[#be576c] py-[5px] px-[5px] text-[white] text-[10px] font-[600] flex justify-center items-center">
                  15% off
                </span>
                <span>
                  <FaRegHeart />
              ...
              <div className="w-[100%] h-[25%] ">
                ...
                <div className="flex w-[100%] justify-between items-center mt-[]">
                  ...
                  <div className="text-[10px] font-[700] border px-1 py-1 text-[black] mr-[5px] cursor-pointer">
                    Add to Cart
                  </div>
                </div>
              </div>
