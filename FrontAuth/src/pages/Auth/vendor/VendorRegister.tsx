...
import { createvendorAccount } from "../../../api/api";
...
const VendorRegister = () => {
  ...
  const onhandleSubmit = handleSubmit(async (data: {}) => {
    ...
    await createvendorAccount(data).then(() => {
        ...
        <div className="w-[90%] lg:w-[100%] px-10 mx-10">
          ...
          <div className=" flex justify-center mt-10 text-[12px]">
            <div>
              ...
              <Link to="/vendor/login" className="font-bold text-white pl-2">
                Login here
              </Link>
            </div>
          </div>
